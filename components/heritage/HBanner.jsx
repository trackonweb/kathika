...
<div className='flex flex-col items-center justify-center  gap-3  w-full'> 
        ...
        <p className='md:text-[20px] text-[16px]  leading-7 text-center text-black'>{`Old Delhi, also known as Shahjahanabad, is a city steeped in history, culture, and heritage, dating back to the 17th century when it was founded by Mughal Emperor Shah Jahan as his new capital. The city is a treasure trove of architectural styles, with monuments like the Red Fort, Jama Masjid, and Chandni Chowk showcasing the rich history and diverse cultural influences that have shaped it over time.
