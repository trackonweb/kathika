...
const ContactModel1 = ({handleCloseContactModel1, handleOpenContactModel1}) => {
  return (
    <div>
       <div
        id="default-modal"
        className={`${
            handleOpenContactModel1 ? 'flex' : 'hidden'
    ...
    <a className="font-jost font-[400] text-[18px] text-blue-600">  +91 9650339839

</a>,
  </Link>

<Link href="tel:+919811276231">
    <a className="font-jost font-[400] text-[18px] text-blue-600"> +91 9811276231</a>,
  </Link>

    </div>
       <div className='absolute top-2 right-1 ' >
        <IoClose onClick={handleCloseContactModel1}   className='text-[30px] font-bold cursor-pointer'/>
       </div> 
       </div>
