...
<h3 className='md:text-[40px] text-[30px] text-center font-Yeseva py-5'>Kathika Museum Haveli</h3>
...
<div className='flex flex-col items-center justify-center  gap-3  w-full'> 
           ...
           <p className='md:text-[20px] text-[15px]  leading-7 text-center text-black'>{`Kathika, a unique museum-haveli in Old Delhi, that takes on the role of a storyteller, breathing life into the captivating tales of cultural history and celebrating heritage in the vicinity of Kucha Pati Ram . Run by the Kathika Trust, it showcases the restoration of architectural treasures and a commitment to adaptive reuse and sustainable development. The Haveli, a combination of art and architecture, houses a collection of everyday artefacts and artistic treasures from Atul Khanna's personal collection. Visitors can also access a curated library to learn more about Delhi's enchanting narratives.`} </p>
            </div>
    ...
    <p className='md:text-[20px] text-[15px]  leading-7 text-justify py-5'>{`The Kathika Museum provides an insight into the architectural marvel of the Havelis of Old Delhi and also exhibits a collections of Archival Photographs, Decorative Arts, Paintings and Handicrafts of Old Delhi that tell the story of the medieval ages and the lifestyle of the people of Purani Dilli . 
`}</p>
    </div>
   </div>
  )
