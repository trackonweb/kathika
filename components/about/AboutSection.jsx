...
<p className='md:text-[24px] text-[16px] font-Alice text-center text-black'>Visitors can learn about the city’s rich history and cultural traditions through interactive displays, multimedia exhibits, and live demonstrations. 
</p>
           </div>
